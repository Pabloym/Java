...
import org.uma.mbd.mdTestL.Test.TestAsignatura;
import org.uma.mbd.mdTestL.Test.TestException;
...
public class PruebaTest {
	...
	public static void main(String[] args) {
		...
		//poo.guardaNotaAlumno("recursos/mdTestL/alumnosNota.txt");
		PrintWriter pw = new PrintWriter(System.out,true);
		poo.guardaNotaAlumno(pw);
	}
