...
public class AGUnPunto extends AlgoritmoGenetico {
	...
	protected Cromosoma recombinar(Cromosoma cromosoma1, Cromosoma cromosoma2) {
		int k = Cromosoma.gna.nextInt(cromosoma1.longitud());
		Cromosoma newCromosoma = new Cromosoma(cromosoma1.longitud(),false);
		...
		for (int i=0;i<newCromosoma.longitud()-k;i++){
			newCromosoma.gen(k+i, cromosoma2.gen(i));
		}
