...
public abstract class AlgoritmoGenetico {
	...
	public Individuo ejecuta() {
		for (int i = 0; i < pasos; i++) {
			...
			Cromosoma ind1 = poblacion.individuo(a1).cromosoma();
			Cromosoma ind2 = poblacion.individuo(a2).cromosoma();
			Cromosoma newCromosoma = recombinar(ind1,ind2);
			newCromosoma.mutar(probMutacion);
			poblacion.reemplaza(new Individuo(newCromosoma,problema));
 		}
